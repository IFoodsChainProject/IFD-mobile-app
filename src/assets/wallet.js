 ...
 * @constructor
 */
Wallet.GetUnspent = function($address, $host, $callback, $callbackDev) {
 ...
 * @constructor
 */
Wallet.GetNodeHeight = function($host, $callback, $callbackDev) {
  // $http({
  //   method: 'GET',
 ...
 * @constructor
 */
Wallet.SendTransactionData = function($txData, $host, $callback, $callbackDev) {
 /*  $http({
    method: 'POST',
  ...
  var url =  $host.restapi_host + ':' + $host.restapi_port + '/api/v1/transaction';
  $.ajax({
    url:url,
    type:'post',
    data: '{"Action":"sendrawtransaction", "Version":"1.0.0", "Type":"","Data":"' + $txData + '"}',
